...
//		int counter = listAC.size();
//		System.out.println(counter);
//
//		while(counter > 1) {
//			template = template.replace("<Coma separated Academic Characteristics>", valuesAC);
//			counter = listAC.size() - 1;
//		}
//		if(counter == 1) {
//			template = template.replace("<Coma separated Academic Characteristics>", "and" + valuesAC);
//		}
//		
////		if(count == 1) {
////			template = template.replace("<Coma separated Academic Characteristics>", "and" + valuesAC);
...
//		template = template.replace("<First Course Taken>", course1);
