...
public class ProfileController {
	...
	void handleStaffSave(ActionEvent event) {
		...
		if (title.isEmpty()) {
			AlertUtil.showError("Must enter title");
			return;
		}
		
		if (staffSchool.isEmpty()) {
			AlertUtil.showError("Must enter School of Staff");
			return;
		}
		
		if (department.isEmpty()) {
			AlertUtil.showError("Must enter department");
			return;
		}
		
		if (email.isEmpty()) {
			AlertUtil.showError("Must enter email");
			return;
		}
		
		if (phone.isEmpty()) {
			AlertUtil.showError("Must enter phone number");
			return;
		}
